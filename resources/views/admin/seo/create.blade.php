...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Seo</h5>
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => 'admin.seos.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::text('page', null, array('class'=>'form-control m-input','placeholder'=>'Enter Page')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::textarea('meta_title', null, array('class'=>'form-control m-input','placeholder'=>'Meta Title','rows'=>3,'id'=>'meta_title')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::textarea('meta_description', null, array('class'=>'form-control m-input','placeholder'=>'Meta Description','rows'=>3,'id'=>'meta_description')) !!}
