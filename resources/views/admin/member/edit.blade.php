...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => ['admin.member.update',$member->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="Executive" @if($member->type == 'Executive') selected  @endif>Executive</option>
                            <option value="Member" @if($member->type == 'Member') selected  @endif>Member</option>
                        </select>
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="member_type_id" class="form-control">
                            ...
                            @foreach($membertypes as $position)
                                <option value="{{$position->id}}" @if($member->member_type_id == $position->id) selected  @endif>{{$position->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::text('address', $member->address, array('class'=>'form-control','placeholder'=>'Member Address')) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::url('facebook', $member->facebook, array('class'=>'form-control','placeholder'=>'Facebook Link ')) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::url('twitter', $member->twitter, array('class'=>'form-control','placeholder'=>'Twitter Link ')) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::url('linkedin', $member->linkedin, array('class'=>'form-control','placeholder'=>'Linkedin Link ')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::checkbox('is_active',null, $member->is_active) !!}
