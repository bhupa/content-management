...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Edit Admin Type</h5>
            <div class="heading-elements">
                <a href="{{ route('admin.admin-type.index') }}" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::text('email', $admin->email ?? "", array('class'=>'form-control','placeholder'=>'Post title')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::password('confirm_password', null, array('class'=>'form-control','placeholder'=>'Title')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::checkbox('is_active', 1, $admin->is_active, array('class' => 'switch','data-on-text'=>'On','data-off-text'=>'Off', 'data-on-color'=>'success','data-off-color'=>'danger' )) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
            </fieldset>
            ...
            <input type="hidden" name="admin_type_id" value="{{ $admin->admin_type_id }}">
