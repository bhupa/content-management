...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Admin</h5>
            <div class="heading-elements">
                <a href="{{ route('admin.admin-list.index', [$adminTypeId]) }}" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::email('email', null, array('class'=>'form-control','placeholder'=>'Title')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::password('password', null, array('class'=>'form-control','placeholder'=>'Title')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
