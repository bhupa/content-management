...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => 'admin.setting.store','class'=>'form-horizontal','id'=>'articleForm', 'files' => 'true')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group fg-line" id="link">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control input-sm" name="url" id=""
                               placeholder="Enter Link" value="{{ old('name') }}">
                    </div>
                </div>
                ...
                <div class="form-group fg-line" id="text">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control input-sm" name="url" id=""
                               placeholder="Enter Text" value="{{ old('name') }}">
                    </div>
                </div>
                <div id="image">
