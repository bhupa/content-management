...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => ['admin.blog.update', $blog->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
            <fieldset class="content-group">
                <div class="form-group">
                    <label class="control-label col-lg-2">Title <span class="text-danger">*</span></label>

                    <div class="col-lg-6">
                        {!! Form::text('title', $blog->title, array('class'=>'form-control','placeholder'=>'Post title')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::textarea('description', $blog->description, array('class'=>'form-control editor')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::checkbox('is_active', null, $blog->is_active, array('class' => 'switch','data-on-text'=>'On','data-off-text'=>'Off', 'data-on-color'=>'success','data-off-color'=>'danger' )) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
            </fieldset>
