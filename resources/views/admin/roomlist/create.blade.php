...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => 'admin.roomlist.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true', 'enctype'=>'multipart/form-data' )) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group {{ $errors->has('number_of_rooms') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-6 ">
                        {!! Form::number('number_of_rooms', null, array('class'=>'form-control','placeholder'=>'Number of Rooms')) !!}
                    </div>
                ...
                <div class="form-group {{ $errors->has('description') ? 'has-error' :'' }}">
                    ...
                    <div class="col-lg-10">
                        {!! Form::textarea('description', null, array('class'=>'form-control editor', 'required' => 'true')) !!}
                ...
                <div class="form-group {{ $errors->has('short_description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-lg-10">
                        {!! Form::textarea('short_description', null, array('class'=>'form-control editor', 'required' => 'true')) !!}
