    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                ...
                <a href="{{ route('admin.roomlist-image.index',[$roomlist->id]) }}" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    <form action="{{ route('admin.roomlist-image.store',[$roomlist->id]) }}" class="dropzone" id="dropzone_accepted_files">
