...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => 'admin.news.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::text('meta_title', null, array('class'=>'form-control','placeholder'=>'Post title')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::text('keywords', null, array('class'=>'form-control','placeholder'=>'Post title')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::date('published_date', null, array('class'=>'form-control','placeholder'=>'Published Date')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
