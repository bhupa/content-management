    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                ...
                <a href="{{ route('admin.news.create') }}" class="btn btn-default legitRipple pull-right">
    ...
    @foreach($news as $key=>$new)
                    <tr id="item-{{ $new->id }}">
                        ...
                        <td>
                            ...
                            <img src="{{ asset('storage/'.$new->image)}}" class="displayimage" style="width:100px; height:100px; margin-bottom: 15px;" alt=""></br>
                            @endif
                        </td>
                        <td>{{ Carbon\Carbon::parse($new->published_date)->toFormattedDateString() }}</td>
                        <td>
                            {{ \Carbon\Carbon::parse($new->created_at)->toFormattedDateString() }}
                        </td>
                        <td>
                            {{ \Carbon\Carbon::parse($new->updated_at)->toFormattedDateString() }}
                        </td>
                        <td>
                            @can('master-policy.perform', ['news', 'changeStatus'])
                        ...
                        <td>
                            @can('master-policy.perform', ['news', 'edit'])
                            ...
                            @endif
                            @can('master-policy.perform', ['news', 'delete'])
                            <a href="javascript:void(0)" id="{{ $new->id  }}"
