            ...
            function readURL(input){
                ...
                if(input.files && input.files[0]){
                    ...
                    reader.onload = function(e){
                        ...
                        $('.use').fadeIn();
                        $('.use').click(function(){
                            resize.result({type: 'canvas', size: { width:800,height:400}}).then(function(dataImg) {
...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Notice</h5>
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => 'admin.notice.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::text('timer', null, array('class'=>'form-control','placeholder'=>'Timer')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::date('start_date', null, array('class'=>'form-control','placeholder'=>'Start Date')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::date('end_date', null, array('class'=>'form-control','placeholder'=>'End Date')) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
