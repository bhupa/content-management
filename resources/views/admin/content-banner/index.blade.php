        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "{{ url('admin/content-banner/sort') }}";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.content-banner.change-status') }}",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                @can('master-policy.perform', ['content-banner', 'add'])
                    <a href="{{ route('admin.content-banner.create') }}" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                @foreach($contentbanners as $key=>$banner)
                    <tr id="item-{{ $banner->id }}">

                        <td>{{ $key  + $contentbanners->firstItem()}}</td>
                        <td>{{ $banner->title }}</td>
                        <td>
                        ...
                        <td>
                            @can('master-policy.perform', ['content-banner', 'changeStatus'])
                        ...
                        <td>
                            @can('master-policy.perform', ['content-banner', 'edit'])
                            ...
                            @endif
                            @can('master-policy.perform', ['content-banner', 'delete'])
