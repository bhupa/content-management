...
<section class="home-page-banner-area d-flex text-center" style="min-height:570px; background:linear-gradient(to right, rgba(4, 9, 30, 0.8), rgba(4, 9, 30, 0.8)), url('{{asset('frontend/img/banner.jpg')}}')">
    <div class="container align-self-center">
        <div class="row">
            <div class="col-md-12">
                <div class="banner_content">
                    <h1>Welcome to kasha samaja uk  </h1>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="home-about-image-wrapper">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3593958.0912229526!2d84.13014975!3d28.39738195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2snp!4v1594197526220!5m2!1sen!2snp" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="home-about-content">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet architecto blanditiis cumque doloremque unde. Ad cupiditate dolore doloribus in numquam praesentium quod, veritatis vero! Alias culpa delectus iure magnam sunt?
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet architecto blanditiis cumque doloremque unde. Ad cupiditate dolore doloribus in numquam praesentium quod, veritatis vero! Alias culpa delectus iure magnam sunt?
                    </p>
        ...
        {{--<div class="row">--}}
            {{--<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">--}}
                {{--<div class="post-entry">--}}
                    {{--<a href="#" class="mb-3 img-wrap">--}}
                        {{--<img src="{{asset('frontend/img/bg_3.jpg')}}" alt="Image placeholder" class="img-fluid">--}}
                    {{--</a>--}}
                    {{--<h3><a href="#">Be A Volunteer Today</a></h3>--}}
                    {{--<span class="date mb-2 d-block text-muted">July 26, 2018</span>--}}
                    {{--<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia. far from the countries Vokalia and Consonantia. far from the countries Vokalia and Consonantia.</p>--}}
            ...
            {{--<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">--}}
                {{--<div class="post-entry">--}}
                    ...
                    {{--<span class="date mb-2 d-block text-muted">July 26, 2018</span>--}}
                    {{--<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.far from the countries Vokalia and Consonantia.</p>--}}
                    {{--<p><a href="#" class="link-underline">Read More</a></p>--}}
                {{--</div>--}}
                {{--<hr>--}}
            {{--</div>--}}
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="card fundraise-item">
                    <a href="#"><img class="card-img-top" src="{{asset('frontend/img/bg_3.jpg')}}" alt="Image placeholder"></a>
                    <div class="card-body">
                        <h3 class="card-title"><a href="#">Refugees Needs Food</a></h3>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <span class="donation-time mb-3 d-block">25 July 2020</span>
                        <div class="progress custom-progress-success">
                        </div>
                        <a href="#" class="btn_hover view-more-btn">
                            Get Started
                        </a>
                    </div>
                </div>
...
<section class="home-blog"  id="our-events">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12 text-center">
                <h2>Our Events</h2>
                ...
                <div class="event">
                    <div class="event-img">
                        <a href="single-event.html">
                            <img src="{{asset('frontend/img/bg_3.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="event-content">
                        <h3><a href="single-event.html">Possit nostro aeterno eu vis</a></h3>
                        <ul class="event-meta">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="single_volenteer">
                <div class="volenteer_thumb">
                    <img src="{{asset('frontend/img/vol.png')}}" alt="">
                </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="c1ce2f35d0317a2e91697437-text/javascript"></script>
<script type="c1ce2f35d0317a2e91697437-text/javascript">
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="c1ce2f35d0317a2e91697437-|49" defer=""></script></body>
<script>
