...
<link rel="stylesheet" href="<?php echo e(asset('backend/tablednd.css')); ?>">
    ...
    <script>
        ...
        var url = "<?php echo e(url('admin/team/sort')); ?>";
        $.ajax({
        type: "POST",
        url: url,
        datatype: "json",
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('admin.team.change-status')); ?>",
        data: {
        'id': id,
        },
        dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i> Team</h5>
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['team', 'add'])): ?>
                <a href="<?php echo e(route('admin.team.create')); ?>" class="btn btn-default legitRipple pull-right">
...
<?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($staff->id); ?>">
                        <td><?php echo e($key+1); ?></td>
                        <td><?php echo e($staff->name); ?></td>
                        <td><?php echo e($staff->position); ?></td>
                        <td><?php echo e($staff->member->name); ?></td>
                        <td>    <?php if(file_exists('storage/'.$staff->image) && $staff->image !== ''): ?>
                            <img src="<?php echo e(asset('storage/'.$staff->image)); ?>"
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.team.edit',$staff->id)); ?>"
                               title="Edit Team"
                               data-toggle="tooltip"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                            <a href="javascript:void(0)" id="<?php echo e($staff->id); ?>"
                               title="Delete Team"
                               data-toggle="tooltip"
