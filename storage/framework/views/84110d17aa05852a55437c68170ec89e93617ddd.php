    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.ecd-image.index',[$ecd->id])); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    <form action="<?php echo e(route('admin.ecd-image.store',[$ecd->id])); ?>" class="dropzone" id="dropzone_accepted_files">
