        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/packages/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.packages.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>Packages</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.packages.create')); ?>" class="btn btn-default legitRipple pull-right">
                ...
                <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($item->id); ?>">
                        ...
                        <td>
                            ...
                            <img src="<?php echo e(asset('storage/'.$item->image)); ?>" style="height: 60px;">
                             <?php endif; ?>
                        </td>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.packages.edit',$item->id)); ?>"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                          
                            <a href="<?php echo e(route('admin.packagebanner.index',$item->id)); ?>"
                               class="btn btn-danger btn-icon btn-rounded legitRipple">
                                <i class="icon-calendar3 "></i>
                            </a>

                          
                            <a href="<?php echo e(route('admin.itinerary.index',$item->id)); ?>"
                               class="btn btn-danger btn-icon btn-rounded legitRipple">
