...
<?php $__env->startSection('main'); ?>
    ...
    <div id="custom-header">
        <div class="custom-header-content">
            <div class="container">
                <h1 class="page-title">Central Executive Board</h1>
                <div id="breadcrumb">
                    <div  aria-label="Breadcrumbs" class="breadcrumbs breadcrumb-trail">
                        <ul class="trail-items">
                            ...
                            <li class="trail-item trail-end"><span><?php echo e($member->name); ?></span></li>
                        </ul>
                    </div>
                    <!-- .breadcrumbs -->
                </div>
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main">
                        <?php if(file_exists('storage/'.$member->image) && $member->image !== ''): ?>
                            <div class="contentimg"><img src="<?php echo e(asset('storage/'.$member->image)); ?>" alt="<?php echo e($member->name); ?>" data-action="zoom"></div>
                        <?php endif; ?>
