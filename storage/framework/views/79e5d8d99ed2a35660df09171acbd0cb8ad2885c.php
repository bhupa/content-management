...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            <?php echo Form::open(array('route' => ['admin.team.update',$team->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('name', $team->name, array('class'=>'form-control','placeholder'=>'Name')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('email', $team->email, array('class'=>'form-control','placeholder'=>'Email')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        <?php echo Form::text('period', $team->period, array('class'=>'form-control','placeholder'=>'Insert from-to-end date of member')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $teams[$key->id] = $key->name; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e(Form::select('member_type_id', $teams, $team->member_type_id,['class'=>'form-control', 'placeholder'=>'select Member Type','id'=>'select-category'])); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('position', $team->position, array('class'=>'form-control','placeholder'=>'Please Insert Position')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php if(file_exists('storage/'.$team->image) && $team->image != ''): ?>
                            <img src="<?php echo e(asset('storage/'.$team->image)); ?>" class="displayimage" style="width:100px; height:100px; margin-bottom: 15px;" alt="<?php echo e($team->title); ?>"></br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('description', $team->description, array('class'=>'form-control editor')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    <?php echo Form::checkbox('is_active', null, $team->is_active, array('class' => 'switch','data-on-text'=>'On','data-off-text'=>'Off', 'data-on-color'=>'success','data-off-color'=>'danger' )); ?>
