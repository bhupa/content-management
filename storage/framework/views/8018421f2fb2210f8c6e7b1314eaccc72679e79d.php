...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Service</h5>
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.service.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php echo e(Form::select('service_category_id', $categoies, null,['class'=>'form-control', 'placeholder'=>'select ServiceCategory','id'=>'select-category'])); ?>
