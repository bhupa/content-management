...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create FAQ</h5>
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.faq.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('question', null, array('class'=>'form-control','placeholder'=>'Post title')); ?>
                ...
                <div class="clearfix"></div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <?php echo Form::textarea('answer', null, array('class'=>'form-control editor', 'id'=>'editor', 'required' => 'true')); ?>
