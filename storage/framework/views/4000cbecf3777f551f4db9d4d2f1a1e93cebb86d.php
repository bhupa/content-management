...
<link rel="stylesheet" href="<?php echo e(asset('backend/tablednd.css')); ?>">
    ...
    <script>
        ...
        var url = "<?php echo e(url('admin/messages/sort')); ?>";
        $.ajax({
        type: "POST",
        url: url,
        datatype: "json",
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('admin.messages.change-status')); ?>",
        data: {
        'id': id,
        },
        dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['messages', 'add'])): ?>
                <a href="<?php echo e(route('admin.messages.create')); ?>" class="btn btn-default legitRipple pull-right">
  ...
  <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($message->id); ?>">
                        ...
                        <td><?php echo e($message->team->name); ?></td>
                        <td><?php echo e($message->team->position); ?></td>
                        <td>
                            <?php echo str_limit($message->description,'50','...'); ?>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.messages.edit',$message->id)); ?>"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                            <a href="javascript:void(0)" id="<?php echo e($message->id); ?>"
