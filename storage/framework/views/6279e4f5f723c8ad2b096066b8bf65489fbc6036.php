...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.video.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::text('link', null, array('class'=>'form-control', 'placeholder'=>'Link')); ?>
            ...
            <input type="hidden" name="gallery_id" value="<?php echo e($id); ?>">
