...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Project</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.project.index')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.project.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="clearfix"></div>
                <div class="form-group row <?php echo e($errors->has('featured') ? 'has-errors'  : ''); ?>">
                    <label class="control-label col-lg-2">Feature </label>

                    <div class="col-lg-10">
                        <?php echo Form::textarea('featured', null, array('class'=>'form-control mini-editor','id'=>'editor', )); ?>
                ...
                <div class="form-group <?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-lg-10 ">
                        <?php echo Form::textarea('description', null, array('class'=>'form-control editor','placeholder'=>'Description')); ?>
