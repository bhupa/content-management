...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>View Contact</h5>
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['contact', 'view'])): ?>
                    <a href="<?php echo e(route('admin.contact.index')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title"> <strong>Email:</strong>  <?php echo e($contact->email); ?></h5>
                    <p class="card-text">
