...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Article</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.article.index')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.article.store','class'=>'form-horizontal','id'=>'articleForm', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::text('title', null, array('class'=>'form-control','placeholder'=>'Activity title')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('short_description', null, array('class'=>'form-control mini-editor','placeholder'=>'Meta Keys')); ?>
