...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => ['admin.news.update', $news->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('title', $news->title ?? "", array('class'=>'form-control','placeholder'=>'Post title')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('meta_title', $news->meta_title, array('class'=>'form-control','placeholder'=>'Post title')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('keywords', $news->keywords, array('class'=>'form-control','placeholder'=>'Post title')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php if(file_exists('storage/'.$news->image) && $news->image !== ''): ?>
                            <img src="<?php echo e(asset('storage/'.$news->image)); ?>" class="displayimage" style="width:100px; height:100px; margin-bottom: 15px;" alt=""></br>
                        <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('short_description', $news->short_description ?? "", array('class'=>'form-control editor')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('description', $news->description ?? "", array('class'=>'form-control editor')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::date('published_date', $news->published_date, array('class'=>'form-control','placeholder'=>'Published Date')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::checkbox('is_active', null, $news->is_active, array('class' => 'switch','data-on-text'=>'On','data-off-text'=>'Off', 'data-on-color'=>'success','data-off-color'=>'danger' )); ?>
