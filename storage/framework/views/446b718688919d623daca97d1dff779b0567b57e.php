...
<section class="home-page-banner-area d-flex text-center" style="min-height:570px; background:linear-gradient(to right, rgba(4, 9, 30, 0.8), rgba(4, 9, 30, 0.8)), url('<?php echo e(asset('frontend/img/banner.jpg')); ?>')">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="card fundraise-item">
                    <a href="#"><img class="card-img-top" src="<?php echo e(asset('frontend/img/bg_3.jpg')); ?>" alt="Image placeholder"></a>
                    <div class="card-body">
                ...
                <div class="event">
                    <div class="event-img">
                        <a href="single-event.html">
                            <img src="<?php echo e(asset('frontend/img/bg_3.jpg')); ?>" alt="">
                        </a>
                    </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="single_volenteer">
                <div class="volenteer_thumb">
                    <img src="<?php echo e(asset('frontend/img/vol.png')); ?>" alt="">
                </div>
