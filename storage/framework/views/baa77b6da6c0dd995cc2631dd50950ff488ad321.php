    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 col-lg-8 mb-5">
         ...
         <?php echo e(Form::open(array('route'=>'contact.store', 'class'=>'p-5 bg-white','id'=>'contact-form'))); ?>


            <?php if(session()->has('success')): ?>
                <div class="alert alert-success" > <?php echo e(session()->get('success')); ?> </div>
            <?php endif; ?>
            <div class="row form-group <?php echo e($errors->has('fullname') ? 'has-error' : ''); ?>">
            ...
            <div class="row form-group <?php echo e($errors->has('message') ? 'has-error' : ''); ?>">
              <div class="col-md-12">
        ...
        <div class="col-lg-4">
          <div class="p-4 mb-3 bg-white">
            ...
            <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <?php if($setting->name == 'Address'): ?>
                <p class="mb-0 font-weight-bold">Address</p>
                  <p class="mb-4"><?php echo e($setting->value); ?></p>
                  <?php endif; ?>

              <?php if($setting->name == 'Phone'): ?>
                      <p class="mb-0 font-weight-bold">Phone</p>
                  <p class="mb-4"><a href="JavaScript:Void(0)"><?php echo e($setting->value); ?></a></p>
                 <?php endif; ?>


                <?php if($setting->name == 'Email'): ?>
                      <p class="mb-0 font-weight-bold">Email Address</p>
                  <p class="mb-0"><a href="mailto:<?php echo e($setting->value); ?>"><?php echo e($setting->value); ?></a></p>
                   <?php endif; ?>
