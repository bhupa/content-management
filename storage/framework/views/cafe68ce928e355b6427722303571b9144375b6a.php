...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => ['admin.memberType.update', $memberType->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('name', $memberType->name, array('class'=>'form-control','placeholder'=>'Name')); ?>
