            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.booking.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
            ...
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($booking->id); ?>">
                        ...
                        <td>
                            <?php echo e($booking->first_name); ?> <?php echo e($booking->last_name); ?>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['booking', 'changeStatus'])): ?>
                                <a href="javascript:void(0)"
                                   title="Booking-confirmation"
                                   data-toggle="tooltip"
                                   class="btn btn-primary btn-icon btn-rounded legitRipple change-status"
                                   id="<?php echo e($booking->id); ?>">
                                    <?php if($booking->is_active == 1): ?>
