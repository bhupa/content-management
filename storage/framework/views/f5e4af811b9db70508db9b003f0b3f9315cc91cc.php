...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.imageresize.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::text('title', null, array('class'=>'form-control','placeholder'=>'Module Name')); ?>
                ...
                <div class="clearfix"></div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::text('alias', null, array('class'=>'form-control','placeholder'=>'Alias Name')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <?php echo Form::text('image_resize_width', null, array('class'=>'form-control','placeholder'=>'Image Resize Width')); ?>
                ...
                <div class="clearfix"></div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <?php echo Form::text('image_resize_height', null, array('class'=>'form-control','placeholder'=>'Image Resize Height')); ?>
