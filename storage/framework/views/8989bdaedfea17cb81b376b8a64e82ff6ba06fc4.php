                ...
                <div id="breadcrumb">
                    <div  aria-label="Breadcrumbs" class="breadcrumbs breadcrumb-trail">
                        <ul class="trail-items">
                            ...
                            <li class="trail-item trail-end"><span><?php echo e($blog->title); ?></span></li>
                        </ul>
                    </div>
                    <!-- .breadcrumbs -->
                </div>
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main">
                        ...
                        <?php if(file_exists('storage/'.$blog->image) && $blog->image !== ''): ?>
                            ...
                            <div class="contentimg"><img src="<?php echo e(asset('storage/'.$blog->image)); ?>" alt="" data-action="zoom"></div>
                        <?php endif; ?>
