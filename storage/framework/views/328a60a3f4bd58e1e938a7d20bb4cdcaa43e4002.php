    ...
    <script>
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/blog/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
        ...
        $(document).ready(function () {
          $(".defaultTable").on("click", ".change-status", function () {
             ...
             $.ajax({
             type: "POST",
             url: "<?php echo e(route('admin.blog.change-status')); ?>",
             data: {
             'id': id,
             },
             dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['blog', 'add'])): ?>
                    <a href="<?php echo e(route('admin.blog.create')); ?>" class="btn btn-default legitRipple pull-right">
