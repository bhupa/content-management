...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Event</h5>
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.event.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('title', null, array('class'=>'form-control','placeholder'=>'Event title')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('location', null, array('class'=>'form-control','placeholder'=>'Event Location')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="date" class="form-control" name="date" id="event-date" value="<?php echo e(old('date')); ?>">
                    </div>
                </div>
