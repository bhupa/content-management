        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/service/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.service.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>Service</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.service.create')); ?>" class="btn btn-default legitRipple pull-right">
            ...
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($service->id); ?>">
                        ...
                        <td><?php echo e($service->getcategoryname()); ?></td>
                        <td>
                            <?php if(file_exists('storage/'.$service->image) && $service->image != ''): ?>
                                <img src="<?php echo e(asset('storage/'.$service->image)); ?>"  style="height: 60px;" alt="text">
                            <?php endif; ?>
