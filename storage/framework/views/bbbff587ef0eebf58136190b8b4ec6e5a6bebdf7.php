        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['article', 'view'])): ?>
                        <li class="<?php echo e($secondParam == 'article' ? 'active':''); ?>">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['application', 'view'])): ?>
                        <li class="<?php echo e($secondParam == 'application' ? 'active':''); ?>">
                    ...
                    <?php endif; ?>
                       ...
                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['blog', 'view'])): ?>
                          <li class="<?php echo e($thirdParam == 'blog' ? 'active':''); ?>">
                      ...
                      <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['career', 'view'])): ?>
                        <li class="<?php echo e($secondParam == 'career' ? 'active':''); ?>">
                        ...
                        <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['content', 'view'])): ?>
                                <li class="<?php echo e($secondParam == 'contents' ? 'active':''); ?>">
                                    <a href="<?php echo e(route('admin.counts.index')); ?>">
                                        <i class="icon-stats-bars"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['ecd', 'view'])): ?>
                        <li class="<?php echo e($secondParam == 'ecd' ? 'active':''); ?>">
                            <a href="<?php echo e(route('admin.ecd.index')); ?>">
                                <i class="icon-stats-bars"></i>
                                <span>ECD</span>
                            </a>
                        </li>
                    <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['faq', 'view'])): ?>
                                  <li class="<?php echo e($secondParam == 'faq' ? 'active':''); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform',['booking','view'])): ?>
                        <li class="<?php echo e($secondParam == 'booking' ? 'active':''); ?>">
                            <a href="<?php echo e(route('admin.bookings.index')); ?>"><i class="icon-address-book2 "></i>
                                <span>Inquiry</span></a>
                        </li>
                    <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform',['message','view'])): ?>
                            <li class="<?php echo e($secondParam == 'message' ? 'active':''); ?>">
                        ...
                        <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['organization', 'view'])): ?>
                                <li class="<?php echo e($secondParam == 'organization' ? 'active':''); ?>">
                                    <a href="<?php echo e(route('admin.organization.index')); ?>">
                                        <i class="icon-location3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['programs', 'view'])): ?>
                        <li class="<?php echo e($secondParam == 'programs' ? 'active':''); ?>">
                    ...
                    <?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['project', 'view'])): ?>
                                        <li class="<?php echo e($secondParam == 'project' ? 'active':''); ?>">
                                            <a href="<?php echo e(route('admin.project.index')); ?>">
                                                <i class="icon-location3"></i>
                                                <span>Product</span>
                                            </a>
                                        </li>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['service-category', 'view'])): ?>
                            <li class="<?php echo e($secondParam == 'service-category' ? 'active':''); ?>">
                                <a href="<?php echo e(route('admin.service-categories.index')); ?>">
                                    <i class="icon-location3"></i>
                                    <span>Service-Category</span>
                                </a>
                            </li>
                            <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['service', 'view'])): ?>
                            <li class="<?php echo e($secondParam == 'service' ? 'active':''); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['tranning', 'view'])): ?>
                          <li class="<?php echo e($secondParam == 'tranning' ? 'active':''); ?>">
                            <a href="<?php echo e(route('admin.tranning.index')); ?>">
                                <i class="icon-location3"></i>
                                <span>Tranning</span>
                            </a>
                        </li>
                  <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['partner', 'view'])): ?>
                          <li class="<?php echo e($secondParam == 'partner' ? 'active':''); ?>">
                  ...
                  <?php endif; ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['download', 'view'])): ?>
                                                    <li class="<?php echo e($secondParam == 'download' ? 'active':''); ?>">
