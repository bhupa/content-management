...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.partner.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-lg-6 ">
                        <?php echo Form::text('name', null, array('class'=>'form-control','placeholder'=>'Title')); ?>
