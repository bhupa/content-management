...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>CreateTranning</h5>
        ...
        <div class="panel-body">
            ...
            <?php echo Form::open(array('route' => 'admin.tranning.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
