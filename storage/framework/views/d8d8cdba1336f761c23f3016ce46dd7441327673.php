        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/blog/category/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.blog.category.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
            ...
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <?php if(auth()->user()->can('master-policy.perform',['blog_categories', 'edit'])): ?>
                            ...
                            <?php if(auth()->user()->can('master-policy.perform',['blog_categories', 'delete'])): ?>
                                <?php if($category->blogs->isEmpty()): ?>
                                <a href="javascript:void(0)" id="<?php echo e($category->id); ?>"
