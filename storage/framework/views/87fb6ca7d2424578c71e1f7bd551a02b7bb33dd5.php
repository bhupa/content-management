        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/service-categories/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.service-categories.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
            ...
            $(".defaultTable").on("click", ".delete", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: rootUrl + "/admin/service-categories" + "/" + id,
                            data: {
                                id: id,
                                _method: 'DELETE'
                            },
...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>Service-Category</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.service-categories.create')); ?>" class="btn btn-default legitRipple pull-right">
            ...
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($service->id); ?>">
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.service-categories.edit',$service->id)); ?>"
                               title="Edit-Service"
                               data-toggle="tooltip"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                            <a href="javascript:void(0)" id="<?php echo e($service->id); ?>"
