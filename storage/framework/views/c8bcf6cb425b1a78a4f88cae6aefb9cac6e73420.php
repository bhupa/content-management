                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    ...
                    <div class="row form-group <?php echo e($errors->has('first_name') ? 'has-error' : ''); ?>">
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label class="font-weight-bold" for="fullname">First Name<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('last_name') ? 'has-error' : ''); ?>">
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label class="font-weight-bold" for="lastname">Last Name<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('address') ? 'has-error': ''); ?>">
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label class="font-weight-bold" for="address">Address<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('room_id') ? 'has-error' : ''); ?>">
                        <div class="col-md-12">
                            <label class="font-weight-bold" for="message">Room<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('no_of_room') ? 'has-error' : ''); ?>">
                        <div class="col-md-12">
                            <label class="font-weight-bold" for="message">Number of room<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('no_of_adult') ? 'has-error' : ''); ?>">
                        <div class="col-md-12">
                            <label class="font-weight-bold" for="message">Number of adult<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('no_of_child') ? 'has-error' : ''); ?>">
                        <div class="col-md-12">
                            <label class="font-weight-bold" for="message">Number of child<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('check_in') ? 'has-error' : ''); ?>">
                        <div class="col-md-12">
                            <label class="font-weight-bold" for="message">Check-in<span>*</span></label>
                    ...
                    <div class="row form-group <?php echo e($errors->has('check_out') ? 'has-error' : ''); ?>">
                        <div class="col-md-12">
                            <label class="font-weight-bold" for="message">Check-out<span>*</span></label>
