...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i> Job Application</h5>
  ...
  <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e($key  + $applications->firstItem()); ?></td>
            <td><?php echo e($application->name); ?></td>
            <td><?php echo $application->email; ?></td>
            <td><?php echo $application->phone; ?></td>
            <td><?php echo $application->career->position; ?></td>
            <td><?php echo str_limit($application->subject,'20','..'); ?></td>
            <td><?php echo str_limit($application->message,'20','..'); ?></td>
            <td>
