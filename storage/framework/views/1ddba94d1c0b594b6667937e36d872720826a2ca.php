            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.admin-list.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.admin-list.create', [$adminTypeId])); ?>" class="btn btn-default legitRipple pull-right">
            ...
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.admin-list.edit',$item->id)); ?>"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>

                            <a href="javascript:void(0)" id="<?php echo e($item->id); ?>" data-user_type_id = "<?php echo e($adminTypeId); ?>"
