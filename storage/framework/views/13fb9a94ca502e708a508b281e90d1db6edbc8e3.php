...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Content Count</li>
        </ul>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <?php echo Form::open(array('route' => 'admin.counts.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
        ...
        <fieldset class="content-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <?php echo Form::text('count', null, array('class'=>'form-control','placeholder'=>'Count')); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <?php echo Form::text('icon', null, array('class'=>'form-control','placeholder'=>'Insert ')); ?>
