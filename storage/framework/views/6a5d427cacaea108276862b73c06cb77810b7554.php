            ...
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['career', 'view'])): ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['career-form', 'view'])): ?>
                            <li class="<?php echo e($secondParam == 'career-form' ? 'active':''); ?>">
                                <a href="<?php echo e(route('admin.careersform.index')); ?>">
                                    <i class="icon-location3"></i>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['destination', 'view'])): ?>
                          <li class="<?php echo e($secondParam == 'destination' ? 'active':''); ?>">
                            <a href="<?php echo e(route('admin.destination.index')); ?>">
                                <i class="icon-location3"></i>
                  ...
                  <?php endif; ?> 
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['packages', 'view'])): ?> 
                          <li class="<?php echo e($secondParam == 'packages' ? 'active':''); ?>">
