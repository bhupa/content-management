         ...
         $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/testimonials/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
        ...
        $(document).ready(function () {
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(url('admin/testimonials/change-status')); ?>",
                        data: {
                            'id': id,
                        },
                        dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['testimonial', 'add'])): ?>
                    <a href="<?php echo e(route('admin.testimonials.create')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($testimonial->id); ?>">
                        <td><?php echo e($index+1); ?></td>
                        <td><?php echo e($testimonial->name); ?></td>
                       
                        <td>
                            <?php if(file_exists('storage/'.$testimonial->image) && $testimonial->image !== ''): ?>
                                <img src="<?php echo e(asset('storage/'.$testimonial->image)); ?>" class="displayimage" style="width:100px; height:100px; margin-bottom: 15px;" alt="$testimonial->image"></br>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['testimonial', 'changeStatus'])): ?>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['testimonial', 'edit'])): ?>
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['testimonial', 'delete'])): ?>
                                    <a href="javascript:void(0)" id="<?php echo e($testimonial->id); ?>"
