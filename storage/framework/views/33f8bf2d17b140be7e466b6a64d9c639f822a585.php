...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Organization</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.organization.index')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => ['admin.organization.update',$organization->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('name', $organization->name, array('class'=>'form-control','placeholder'=>'Name')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php if(file_exists('storage/'.$organization->image) && $organization->image !== ''): ?>
                            <img src="<?php echo e(asset('storage/'.$organization->image)); ?>" class="displayimage" style="width:100px; height:100px; margin-bottom: 15px;" alt="<?php echo e($organization->name); ?>"></br>
                        <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('description', $organization->description, array('class'=>'form-control editor')); ?>
