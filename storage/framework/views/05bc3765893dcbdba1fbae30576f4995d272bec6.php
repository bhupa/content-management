<?php $__env->startSection('title', $tranning->name); ?>
...
<?php $__env->startSection('main'); ?>
    ...
    <div id="custom-header">
        <div class="custom-header-content">
            <div class="container">
                <h1 class="page-title"><?php echo e($tranning->name); ?></h1>
                <div id="breadcrumb">
                    <div  aria-label="Breadcrumbs" class="breadcrumbs breadcrumb-trail">
                        <ul class="trail-items">
                            ...
                            <li class="trail-item trail-end"><span><?php echo e($tranning->name); ?></span></li>
                        </ul>
                    </div>
                    <!-- .breadcrumbs -->
                </div>
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main">
                        <?php if(file_exists('storage/'.$tranning->image) && $tranning->image !== ''): ?>
                            <div class="contentimg"><img src="<?php echo e(asset('storage/'.$tranning->image)); ?>" alt="" data-action="zoom"></div>
                        <?php endif; ?>

                        <?php echo $tranning->description; ?>
