      ...
      <div class="col-grid-3">
        <div class="featured-page-section">
          <div class="">
            ...
            <?php if(file_exists('storage/'.$content->image) && $content->image != ''): ?> <img alt="<?php echo e($content->title); ?>" src="<?php echo e(asset('storage/'.$content->image)); ?>" style="margin-bottom:10px;"> <?php endif; ?>
  ...
  <div class="container">
    <div class="inner-wrapper">
      ...
      <div class="col-grid-6 missiongoals">
        ...
        <iframe width="100%" height="310" src="https://www.youtube.com/embed/xf7oGxlwUW4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <div class="inner-wrapper">
      ...
      <div class="col-grid-4 blocks1">
        <div class="section-wrapper"> <a href="<?php echo e(route('blogs.show',[$event->slug])); ?>"> <?php if(file_exists('storage/'.$event->image) && $event->image != ''): ?> <img alt="<?php echo e($event->title); ?>" src="<?php echo e(asset('storage/'.$event->image)); ?>"> <?php endif; ?> </a>
          <h2><a href="<?php echo e(route('blogs.show',[$event->slug])); ?>"><?php echo e(str_limit($event->title,'50','...')); ?></a></h2>
