            ...
            $(".gallery").on("click", ".delete", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: baseUrl + "/admin/ecd/image" + "/" + ecd + "/" + id,
                            data: {
                                id: id,
                                _method: 'DELETE'
                            },
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>Ecd Images</h5>
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform',['ecd','add'])): ?>
                <a href="<?php echo e(route('admin.ecd-image.create', [$ecd->id])); ?>"
        ...
        <div class="panel-body gallery">
            ...
            <div class="row">
                <?php $__empty_1 = true; $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-sm-6 col-lg-3" id="imageItem-<?php echo e($image->id); ?>">
                        <div class="card">
                            <div class="card-img-actions m-1">
                                <img class="card-img img-fluid" src="<?php echo e(asset('storage/'.$image->image)); ?>" alt=""
                                ...
                                <div class="card-img-actions-overlay card-img">
                                    ...
                                    <a href="javascript:void(0)" id="<?php echo e($image->id); ?>" data-gallery = "<?php echo e($ecd->id); ?>"
