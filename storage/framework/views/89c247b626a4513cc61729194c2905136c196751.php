            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.blog.blog.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
            ...
            $(".defaultTable").on("click", ".delete", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: baseUrl + "/admin/blog/blog" + "/" + id,
                            data: {
                                id: id,
                                _method: 'DELETE'
                            },
...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>Post</h5>
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['blog', 'view'])): ?>
                <a href="<?php echo e(route('admin.blog.blog.create')); ?>" class="btn btn-default legitRipple pull-right">
            ...
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <?php echo e(\Carbon\Carbon::parse($blog->updated_at)->toFormattedDateString()); ?>

                        </td>
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['blog', 'changeStatus'])): ?>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['blog', 'edit'])): ?>
                                <a href="<?php echo e(route('admin.blog.blog.edit',$blog->id)); ?>"
                                   class="btn btn-success btn-icon btn-rounded legitRipple">
                                    <i class=" icon-database-edit2"></i>
                                </a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['blog', 'delete'])): ?>
                                <a href="javascript:void(0)" id="<?php echo e($blog->id); ?>"
