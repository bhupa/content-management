            ...
            <div id="breadcrumb">
                <div  aria-label="Breadcrumbs" class="breadcrumbs breadcrumb-trail">
                    <ul class="trail-items">
                        ...
                        <li class="trail-item trail-end"><span>News List</span></li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="latest-posts-wrapper box-shadow-block">
                                            ...
                                            <div class="latest-posts-text-content-wrapper">
                                                <div class="latest-posts-text-content">
                                                    <h3 class="latest-posts-title"> <a href="<?php echo e(route('news.show',[$new->slug])); ?>"><?php echo e(str_limit($new->title,'30','...')); ?></a> </h3>
                                                    <div class="entry-meta latest-posts-meta"> <span class="posted-on"><?php echo e($new->published_date->format('M d Y')); ?></span> </div>
                                                    <div class="latest-posts-summary">
                                                        <div class="homepage-div"><?php echo str_limit($new->description,'100','...'); ?></div>
                                                    </div>
                                                    <a href="<?php echo e(route('news.show',[$new->slug])); ?>" class="more-link button-curved">Know More</a> </div>
