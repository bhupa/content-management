            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.module.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.module.create')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($module->id); ?>">
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0)" id="<?php echo e($module->id); ?>"
                               title="Delete-Module"
                               data-toggle="tooltip"
