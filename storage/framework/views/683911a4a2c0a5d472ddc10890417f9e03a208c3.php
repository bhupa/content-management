        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(url('admin/project/sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
            ...
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('admin.project.change-status')); ?>",
                            data: {
                                'id': id,
                            },
                            dataType: 'json',
...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i>Product</h5>
            <div class="heading-elements">
                <a href="<?php echo e(route('admin.project.create')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($project->id); ?>">
                        <td><?php echo e($key+1); ?></td>
                        <td><?php echo e($project->title); ?></td>
                        <td>
                            <?php if(file_exists('storage/'.$project->image) && $project->image != ''): ?>
                                <img src="<?php echo e(asset('storage/'.$project->image)); ?>"  style="height: 60px;" alt="text">
                            <?php endif; ?>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.project.edit',$project->id)); ?>"
                               title="Edit-Project"
                               data-toggle="tooltip"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                            <a href="javascript:void(0)" id="<?php echo e($project->id); ?>"
