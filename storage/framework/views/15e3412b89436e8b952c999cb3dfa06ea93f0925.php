...
<link rel="stylesheet" href="<?php echo e(asset('backend/tablednd.css')); ?>">
    ...
    <script>
        ...
        var url = "<?php echo e(url('admin/ecd/sort')); ?>";
        $.ajax({
        type: "POST",
        url: url,
        datatype: "json",
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('admin.ecd.change-status')); ?>",
        data: {
        'id': id,
        },
        dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i> ECD Media</h5>
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['ecd', 'add'])): ?>
                <a href="<?php echo e(route('admin.ecd.create')); ?>" class="btn btn-default legitRipple pull-right">
...
<?php $__currentLoopData = $ecds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($item->id); ?>">
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.ecd.edit',$item->id)); ?>"
                               title="Edit-Ecd"
                               data-toggle="tooltip"
                            ...
                            <a href="<?php echo e(route('admin.ecd-image.index', [$item->id])); ?>"
                               title="Add Image to Ecd
                                   data-toggle="tooltip"
