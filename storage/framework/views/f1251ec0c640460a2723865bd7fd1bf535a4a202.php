...
<link rel="stylesheet" href="<?php echo e(asset('backend/tablednd.css')); ?>">
    ...
    <script>
        ...
        var url = "<?php echo e(url('admin/faq/sort')); ?>";
        $.ajax({
        type: "POST",
        url: url,
        datatype: "json",
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('admin.faq.change-status')); ?>",
        data: {
        'id': id,
        },
        dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-grid3 position-left"></i> FAQ</h5>
            <div class="heading-elements">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['faq', 'add'])): ?>
                <a href="<?php echo e(route('admin.faq.create')); ?>" class="btn btn-default legitRipple pull-right">
 ...
 <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($faq->id); ?>">
                        ...
                        <td><?php echo str_limit($faq->answer,'100','...'); ?></td>
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['faq', 'changeStatus'])): ?>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['faq', 'edit'])): ?>
                            <a href="<?php echo e(route('admin.faq.edit',$faq->id)); ?>"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['faq', 'delete'])): ?>
                            <a href="javascript:void(0)" id="<?php echo e($faq->id); ?>"
