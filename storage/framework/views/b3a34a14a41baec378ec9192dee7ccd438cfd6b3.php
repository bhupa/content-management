...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Edit Member</h5>
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => ['admin.member.update',$member->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('name', $member->name, array('class'=>'form-control','placeholder'=>'Member Name')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="Executive" <?php if($member->type == 'Executive'): ?> selected  <?php endif; ?>>Executive</option>
                            <option value="Member" <?php if($member->type == 'Member'): ?> selected  <?php endif; ?>>Member</option>
                        </select>
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="member_type_id" class="form-control">
                            ...
                            <?php $__currentLoopData = $membertypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($position->id); ?>" <?php if($member->member_type_id == $position->id): ?> selected  <?php endif; ?>><?php echo e($position->name); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('address', $member->address, array('class'=>'form-control','placeholder'=>'Member Address')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::url('facebook', $member->facebook, array('class'=>'form-control','placeholder'=>'Facebook Link ')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::url('twitter', $member->twitter, array('class'=>'form-control','placeholder'=>'Twitter Link ')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::url('linkedin', $member->linkedin, array('class'=>'form-control','placeholder'=>'Linkedin Link ')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::checkbox('is_active',null, $member->is_active); ?>
            ...
            <?php echo Form::hidden('id', $member->id); ?>
