                        ...
                        <aside class="section section-latest-posts lite-background">
                            <div class="container">
                                <div class="latest-posts-section">
                                    ...
                                    <!-- .section-title-wrap -->
                                    <div class="inner-wrapper">
                                        <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-grid-4 latest-posts-item newslist-page">
                                                <div class="latest-posts-wrapper box-shadow-block">
                                                    <div class="latest-posts-thumb">
                                                        <a href="<?php echo e(route('blogs.show',[$new->slug])); ?>" >
                                                    ...
                                                    <div class="latest-posts-text-content-wrapper">
                                                        <div class="latest-posts-text-content">
                                                            <h3 class="latest-posts-title"> <a href="<?php echo e(route('blogs.show',[$new->slug])); ?>"><?php echo e(str_limit($new->title,'60','...')); ?></a> </h3>
                                                            ...
                                                            <div class="latest-posts-summary">
                                                                <?php echo str_limit($new->description,'80','...'); ?>

                                                            </div>
                                                            <a href="<?php echo e(route('blogs.show',[$new->slug])); ?>" class="more-link button-curved">Know More</a> </div>
