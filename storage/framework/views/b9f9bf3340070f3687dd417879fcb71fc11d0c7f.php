...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Roomlist</h5>
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.roomlist.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true', 'enctype'=>'multipart/form-data' )); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group <?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-lg-6 ">
                        <?php echo Form::text('price', null, array('class'=>'form-control','placeholder'=>'price')); ?>
                ...
                <div class="form-group <?php echo e($errors->has('number_of_rooms') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-lg-6 ">
                        <?php echo Form::number('number_of_rooms', null, array('class'=>'form-control','placeholder'=>'Number of Rooms')); ?>
                ...
                <div class="form-group <?php echo e($errors->has('description') ? 'has-error' :''); ?>">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('description', null, array('class'=>'form-control editor', 'required' => 'true')); ?>
                ...
                <div class="form-group <?php echo e($errors->has('short_description') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-lg-10">
                        <?php echo Form::textarea('short_description', null, array('class'=>'form-control editor', 'required' => 'true')); ?>
