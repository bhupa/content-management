        ...
        $(function(){
            ...
            $('#sortable').sortable({
                ...
                update: function(event, ui){
                    ...
                    var url = "<?php echo e(route('admin.roomlist.sort')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url,
                        datatype: "json",
        ...
        $(document).ready(function () {
            $(".defaultTable").on("click", ".change-status", function () {
                ...
                Swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(url('admin/roomlist/change-status')); ?>",
                        data: {
                            'id': id,
                        },
                        dataType: 'json',
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                ...
                <a href="<?php echo e(route('admin.roomlist.create')); ?>" class="btn btn-default legitRipple pull-right">
        ...
        <div class="panel-body">
            <table class="table datatable-column-search-inputs defaultTable">
                ...
                <?php $__currentLoopData = $roomlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $roomlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="item-<?php echo e($roomlist->id); ?>">
                        <td><?php echo e($key+1); ?></td>
                        <td><?php echo e($roomlist->name); ?></td>
                        <td>
                            <?php if(file_exists('storage/'.$roomlist->cover_image) && $roomlist->cover_image !== ''): ?>
                                <img src="<?php echo e(asset('storage/'.$roomlist->cover_image)); ?>" style="width:100px;height:100px;"></td>
                        <?php endif; ?>
                        </td>
                        <td><?php echo str_limit($roomlist->description, 100); ?></td>
                        <td><?php echo $roomlist->price; ?></td>
                        <td><?php echo e($roomlist->number_of_rooms); ?></td>

                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['room-list', 'changeStatus'])): ?>
                            <a href="javascript:void(0)"
                               class="btn btn-primary btn-icon btn-rounded legitRipple change-status"
                               id="<?php echo e($roomlist->id); ?>">
                                <?php if( $roomlist->is_active == 1): ?>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['room-list', 'edit'])): ?>
                            <a href="<?php echo e(route('admin.roomlist.edit', $roomlist->id)); ?>"
                               class="btn btn-success btn-icon btn-rounded legitRipple">
                                <i class=" icon-database-edit2"></i>
                            </a>
                            <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['room-list', 'add'])): ?>
                                <a href="<?php echo e(route('admin.roomlist-image.index', [$roomlist->id])); ?>"
                               title="Add Roomlist Images"  class="btn btn-danger btn-icon btn-rounded legitRipple">
                                <i class="icon-gallery "></i>
                            </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('master-policy.perform', ['room-list', 'delete'])): ?>
                                <a href="javascript:void(0)" id="<?php echo e($roomlist->id); ?>"
