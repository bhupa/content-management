...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-file-plus position-left"></i>Create Program</h5>
        ...
        <div class="panel-body">
            <?php echo Form::open(array('route' => 'admin.programs.store','class'=>'form-horizontal','id'=>'download', 'files' => 'true')); ?>
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('meta_title', null, array('class'=>'form-control','placeholder'=>'Meta Title')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php echo Form::text('keywords', null, array('class'=>'form-control','placeholder'=>'Keywords')); ?>
                ...
                <div class="form-group">
                    <label class="control-label col-lg-2">Video Link</label>
                    <div class="col-lg-10">
